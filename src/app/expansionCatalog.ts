...
export const EXPANSION_CATALOG = {
  ...
  giza: entry(
    ...
    families.removal,
    {
      ja: 'ピラミッド状のカードを隣接条件で除去します。',
      en: 'Remove cards from a pyramid using adjacency rules.',
    },
    3,
    1,
    '#c7a165',
    'ピラミッドのカードを条件に合う組み合わせで除去します。',
    [
      '表向きで遮られていないカードを選ぶ。',
      'ルールに合う2枚を組み合わせて除去する。',
      '山札を使って新しい組み合わせを探す。',
    ],
    'Clear the pyramid with valid card combinations.',
    [
      'Select cards that are not covered.',
      'Remove pairs that satisfy the rule.',
      'Use the stock to find new combinations.',
    ],
  ),
  cheops: entry(
    { ja: 'ケオプス', en: 'Cheops' },
    families.removal,
    {
      ja: 'ピラミッドを圧縮しながらカードを除去します。',
      en: 'Remove cards while compressing the pyramid.',
    },
    4,
    1,
    '#b89564',
    'ピラミッドを崩し、隠れたカードをすべて公開します。',
    [
      '露出したカードだけを選ぶ。',
      '合計条件を満たす組を除去する。',
      '列が詰まった後の新しい露出を確認する。',
    ],
    'Collapse the pyramid and expose every hidden card.',
    [
      'Select only exposed cards.',
      'Remove pairs meeting the total rule.',
      'Check the new exposures after each collapse.',
    ],
  ),
  'tri-peaks': entry(
    ...
    1,
    '#70b79a',
    '3つの峰を連続して除去し、山札を使い切ります。',
    [
      '捨て札の上下1ランクを選ぶ。',
      '峰を支えるカードを優先して開ける。',
      '山札をめくりながら連続除去を続ける。',
    ],
    'Clear the three peaks with a continuous run.',
    [
      'Play a card one rank above or below the waste.',
      'Prioritize cards supporting the peaks.',
      'Continue removals while cycling the stock.',
    ],
  ),
  'black-hole': entry(
    ...
    1,
    '#667ba7',
    '盤面の全カードをブラックホールへ移します。',
    [
      '現在の捨て札と隣接するカードを探す。',
      '使えるカードをブラックホールへ移す。',
      '行き止まりでは山札から次の機会を待つ。',
    ],
    'Move every tableau card into the black hole.',
    [
      'Find a card adjacent in rank to the waste.',
      'Move eligible cards into the black hole.',
      'Use the stock when no immediate move remains.',
    ],
  ),
  accordion: entry(
  ...
  'cribbage-squares': entry(
    ...
    families.removal,
    {
      ja: '格子状のカードからクリベッジの役を作ります。',
      en: 'Build cribbage hands on a card grid.',
    },
    4,
    1,
    '#8b9f9e',
    '行と列にクリベッジの役を作り、合計得点を伸ばします。',
    [
      'カードを空きマスへ置く。',
      '各行列の15・ペア・ランを意識する。',
      '盤面完成後に役を集計する。',
    ],
    'Build high-scoring cribbage hands in rows and columns.',
    [
      'Place each card in an empty square.',
