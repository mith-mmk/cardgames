...
export const EXPANSION_CATALOG = {
  ...
  'block-ten': entry(
    ...
    families.removal,
    { ja: '合計10と同じ絵札の組を除去します。', en: 'Remove rank-ten and matching court pairs.' },
    2,
    1,
    '#7db19b',
    '9枚の場札を補充しながら、10以外をすべて除去します。',
    [
      '露出しているカードを確認する。',
      '合計10、または同じJ・Q・Kの2枚を選んで除去する。',
      '空いた場所は山札から補充され、10は最後まで残る。',
    ],
    'Refill nine cells while clearing every card except the tens.',
    [
      'Check the exposed cards.',
      'Remove rank-ten pairs or matching Jacks, Queens, and Kings.',
      'The stock refills gaps; tens remain until the end.',
    ],
  ),
  'fourteen-out': entry(
  ...
  'royal-marriage': entry(
    ...
    1,
    '#c58b70',
    '♥Qと♥Kの間にあるカードを除去して、王と女王を出会わせます。',
    [
      '52枚を折り返しなしの1列として見て、♥Qと♥Kを確認する。',
      '両隣が同ランクまたは同スートなら、その間の1枚を除去する。',
      '両端が一致する隣接2枚も除去し、最後に♥Qと♥Kを隣接させる。',
    ],
    'Remove cards between the Queen and King of Hearts until they meet.',
    [
      'Read all four display rows as one continuous line and locate the Q♥ and K♥.',
      'Discard one interior card when its two neighbours match by rank or suit.',
      'You may also discard two adjacent interior cards when their outer neighbours match.',
    ],
  ),
  'gay-gordons': entry(
    ...
    1,
    '#9f8198',
    '10列と2枚の予備札から、決められた組を除去して盤面を空にします。',
    [
      '10列の最上札と、予備札の一番上を確認する。',
      '合計11、J同士、または異スートのKとQを組にして除去する。',
      '列や予備札への補充・移動はせず、露出した次の札を使う。',
    ],
    'Clear ten columns and a two-card reserve using the prescribed pairs.',
    [
      'Check the ten column tops and the upper reserve card.',
      'Remove two numerals totalling eleven, two Jacks, or an unlike-suit King and Queen.',
      'There is no building or refill; reveal the next card in its pile.',
    ],
  ),
  beehive: entry(
    { ja: 'ビーハイブ', en: 'Beehive' },
    ...
    1,
    '#d6a354',
    '10枚の予備札と6つの蜂の巣に同ランクを集め、4枚そろえて完成させます。',
    [
      '各蜂の巣の上札、予備札、捨て札を確認する。',
      '同ランクの上に重ね、4枚そろった巣は自動的に完成する。',
      '山札は3枚ずつめくり、捨て札を何度でも戻して続ける。',
    ],
    'Build four equal ranks in six hives, using the ten-card reserve and stock.',
    [
      'Check the hive tops, reserve top, and waste top.',
      'Build matching ranks together; a four-card hive clears automatically.',
      'Turn three cards from stock and recycle the waste whenever needed.',
    ],
  ),
  nestor: entry(
    { ja: 'ネスター', en: 'Nestor' },
    ...
    1,
    '#7faaa0',
    '8列と4枚の公開予備札から、同ランクの組を作って全カードを除去します。',
    [
      '各列の一番上と、公開予備札から同ランクを探す。',
      '別の列、または予備札との同ランクの組を選んで除去する。',
      '各列の下に隠れた札を開き、すべてのカードを除去する。',
    ],
    'Make same-rank pairs from eight columns and four open reserve cards.',
    [
      'Check each column top and all four open reserve cards for matching ranks.',
      'Remove a same-rank pair from different columns or a reserve card and a column.',
      'Expose the next cards until every card is removed.',
    ],
  ),
  'poker-squares': entry(
  ...
  'cribbage-solitaire': entry(
    ...
    1,
    '#849ca7',
    '4セットで、2つの6枚手札から各2枚をクリブに選び、5枚役を採点します。',
    [
      '6枚ずつの2手札から、それぞれ2枚をクリブへ選ぶ。',
      'スターターを公開し、2手札とクリブを5枚のクリベッジ役として採点する。',
      '山札を押して次のセットへ進み、4セットの合計得点を伸ばす。',
    ],
    'Choose two cards from each six-card hand for the crib, then score three shows.',
    [
      'Choose two cards from each six-card hand for the crib.',
      'Reveal the starter and score both hands plus the crib as five-card shows.',
      'Use the stock for the next set and maximize the total over four sets.',
    ],
  ),
  'bowling-solitaire': entry(
    ...
    1,
    '#d09a63',
    '20枚のピンとボールを使い、10フレームの標準ボウリング得点を伸ばします。',
    [
      '3つのボール山から1枚を選び、1〜3本の隣接ピンを選ぶ。',
      'ピンの合計の下一桁をボールの数字と合わせてノックする。最初のボールでは奥列を使えない。',
      '投球を切り替え、ストライク・スペアのボーナスを含む10フレームの得点を確定する。',
    ],
    'Use the 20-card pin and ball rack to maximize a standard ten-frame bowling score.',
    [
      'Choose one card from a ball pile, then select one to three adjacent pins.',
      'Knock pins whose total ends in the ball-card number; the first ball cannot hit the back row.',
      'Change balls as needed and finish ten frames with normal strike and spare bonuses.',
    ],
  ),
