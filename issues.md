...
| Existing browser regression | Pass with one expected desktop skip | 75 Playwright checks passed; the compact-touch test is intentionally skipped in the desktop project and passes in `mobile-chrome`.                                                                                                      |
| UI evidence                 | Remediated boards verified          | Desktop and mobile browser checks cover Poker/Cribbage Squares, Tri-Peaks, Black Hole, Giza, Cheops, Accordion, Monte Carlo, Nestor, Royal Marriage, Gay Gordons, Beehive, Cribbage Solitaire, Bowling, Aces Up, and compact landscape. |
...
| -------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1       | Several named layouts are still generic                                 | `pileLayout` now includes Clock, Pyramid, scoring grids, Tri-Peaks, Black Hole, Accordion, Royal Marriage, Nestor, Gay Gordons, Beehive, and Bowling. Fans, crescents, quilts, and windmills still need their own board renderers before their catalog entries can be treated as fully presented. |
...
| P1       | Score detail presentation remains partial                               | The shared screen now exposes score and phase for Poker/Cribbage Squares, Cribbage Solitaire, and Bowling Solitaire. A detailed per-line/per-frame score sheet is still a future UI enhancement.                                                                                                  |
