...
| Known incomplete / do not release as implemented                                    | Monte Carlo, Block Ten, Fourteen Out, Royal Marriage, Gay Gordons, Beehive, Nestor, Cribbage Solitaire, Bowling Solitaire.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |

The next remediation release should replace the remaining generic removal/scoring games one at a time with rule fixtures and layout-specific UI tests, beginning with Monte Carlo.
